...
export const buildSystemHealthSummary = ({ access, memberEmail, cpf, vacancies, bookStorage }) => {
  const categories = [
    ...
    { id: 'health-book-storage', label: 'Arquivo privado do Livro', detailAvailable: false, critical: bookStorage?.ready ? 0 : 1, warning: 0, analyzed: 1 },
  ];
